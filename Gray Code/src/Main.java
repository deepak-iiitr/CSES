...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<String> arr=grayNumbers(n);
    ...
    static ArrayList<String> grayNumbers(int n){
        if(n<=0){
            return new ArrayList<>(){{add("0");}};
        }

        if(n==1){
            return new ArrayList<>(){{add("0");add("1");}};
        }

        ArrayList<String> recAns=grayNumbers(n-1);
